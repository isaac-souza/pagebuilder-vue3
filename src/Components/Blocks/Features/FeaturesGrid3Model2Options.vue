<template>
    <div class="">
      ...
      <div class="form-control">
        ...
        <input v-model="color" type="text" class="input input-bordered input-sm">
      </div>
...
<script>
    ...
    export default defineComponent({
        name: 'FeaturesGrid3Model2Options',
        ...
        setup(props, context) {
            ...
            return { block, add, remove, title, description, color, truncateText }
        },
    })
</script>
