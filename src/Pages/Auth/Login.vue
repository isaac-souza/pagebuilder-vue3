<template>
    <div>
        <AuthLayout>
            ...
            <div class="flex items-center border border-gray-300 py-2 px-3 rounded-lg mb-4">
            ...
            <div class="flex items-center border border-gray-300 py-2 px-3 rounded-lg">
            ...
            <router-link :to="{name: 'Register'}" class="text-sm ml-2 hover:text-blue-500 cursor-pointer">Don't have an account?</router-link>
        </AuthLayout>
    </div>
</template>
